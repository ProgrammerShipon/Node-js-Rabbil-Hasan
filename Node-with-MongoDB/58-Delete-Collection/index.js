...
mongodbClient.connect(URL, config, function(err, myMongoClinets) {
   if (err) {
      ...
      // createMyCollection (myMongoClinets);
      DeleteMyCollection (myMongoClinets);
   }
})
...
/*
function createMyCollection (myMongoClinets) {
   var myDataBase = myMongoClinets.db('Rabbil_School');
   myDataBase.createCollection('teachers', function(err, result ) {
      console.log(result);
   })
}
*/

function DeleteMyCollection (myMongoClinets) {
   var myDataBase = myMongoClinets.db('Rabbil_School');
   myDataBase.dropCollection('teachers', function(err, result ) {
      console.log(result);
   })
}
